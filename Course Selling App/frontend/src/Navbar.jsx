...
//                         Home
//                     </Link>
//                     <Link to="/courses" className="text-gray-800 hover:text-gray-900">
//                         Courses
//                     </Link>
...
//                         <button className="w-fit bg-gray-800 hover:bg-black transition ease-linear text-white rounded-md p-2 text-sm">
//                             SignUp
//                         </button>
//                     </Link>
//                         <Link to="/login">
...
//                             Courses
//                         </Link>
//                         <Link to="/about" className="block text-gray-800 hover:text-gray-700" onClick={() => setIsOpen(false)}>
//                             About
//                         </Link>
//                         <Link to="/contact" className="block text-gray-800 hover:text-gray-700" onClick={() => setIsOpen(false)}>
//                             Contact
//                         </Link>
//                         <Link to="/signup" className="block" onClick={() => setIsOpen(false)}>
//                             <button className="  w-fit bg-gray-800 hover:bg-black transition ease-linear text-white rounded-md p-2">
//                                 SignUp
//                             </button>
//                         </Link>
    ...
    return (
        <nav style={fontMontserrat} className="bg-white shadow-md">
            <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex gap-2">
                    {user && user.firstName ? (
                        // <div className="text-gray-800" style={fontLora}>Welcome, {user.firstName}</div>
                        <div>
